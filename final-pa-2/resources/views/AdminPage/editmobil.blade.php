                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="nik" value="{{$mobiledit->harga_perhari}}" name="harga_perhari" class="form-control" placeholder="Nama mobil">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-icon mb-3">
                                        ...
                                        <input type="text" id="jabatan" value="{{$mobiledit->asal_mobil}}" name="no_plat"
